      ...
      <div className="container px-4 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-base lg:text-lg text-muted-foreground max-w-2xl mx-auto">
            Book a free strategy call. No fluff, no sales pitch — just honest insights 
        ...
        <div className="max-w-4xl mx-auto">
          {/* Main CTA Card */}
          <div
            className={`p-8 lg:p-12 rounded-2xl bg-card border border-border mb-8 text-center transition-all duration-700 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
          >
            ...
            <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
              30 minutes. No commitment. We'll discuss your goals, challenges, and 
              how we can help you scale — compliantly.
            </p>
